...
/// <reference path="exceptions/EntityIsNotEnabledException.ts" />
/// <reference path="exceptions/EntityIsAlreadyReleasedException.ts" />
/// <reference path="exceptions/EntityAlreadyHasComponentException.ts" />
/// <reference path="exceptions/EntityDoesNotHaveComponentException.ts" />
/**
 * entitas ecs
 * @const
 */
